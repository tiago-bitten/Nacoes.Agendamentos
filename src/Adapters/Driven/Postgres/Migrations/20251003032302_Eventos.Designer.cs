...
namespace Postgres.Migrations
{
    ...
    [Migration("20251003032302_Eventos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nacoes.Agendamentos.Domain.Entities.Eventos.Evento", b =>
                {
                    ...
                    b.Property<int?>("QuantidadeMaximaReservas")
            ...
            modelBuilder.Entity("Nacoes.Agendamentos.Domain.Entities.Eventos.Reservas.Reserva", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("AtividadeId")
                        .HasDatabaseName("ix_reserva_atividade_id");

                    b.HasIndex("EventoId")
                        .HasDatabaseName("ix_reserva_evento_id");

                    b.HasIndex("VoluntarioMinisterioId")
                        .HasDatabaseName("ix_reserva_voluntario_ministerio_id");

                    b.HasIndex("DataCriacao", "Id")
                        .IsDescending()
                        .HasDatabaseName("ix_reserva_data_criacao_id");
            ...
            modelBuilder.Entity("Nacoes.Agendamentos.Domain.Entities.Eventos.Reservas.Reserva", b =>
                {
                    b.HasOne("Nacoes.Agendamentos.Domain.Entities.Ministerios.Atividade", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_reserva_atividade_atividade_id");
                    ...
                    b.HasOne("Nacoes.Agendamentos.Domain.Entities.Eventos.Evento", "Evento")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reserva_evento_evento_id");
                    ...
                    b.HasOne("Nacoes.Agendamentos.Domain.Entities.Voluntarios.VoluntarioMinisterio", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reserva_voluntario_ministerio_voluntario_ministerio_id");
